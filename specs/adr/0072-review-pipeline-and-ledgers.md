...
**The collision bound is honest rather than absolute.** 24 bits: 24 bits, so two *concurrently open* branches colliding is negligible at any plausible number of them, and a collision would
