...
- Extended by: [ADR-0049](0049-core-service-skeleton-implementation-decisions.md) — the `[service]` config section parsed under these discovery/validation rules
- Extended by: [ADR-0066](0066-startup-permission-verification.md) — the reader half of the owner-only writer obligation (startup permission verification)
