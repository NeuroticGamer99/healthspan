...
- An unmarked directory older than a **24-hour grace period** is an orphan — a run killed before it could mark itself — and is collected. Without that, "unmarked means leave it alone" would be an unbounded promise.
