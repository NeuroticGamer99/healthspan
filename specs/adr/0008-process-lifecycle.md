...
- Extended by: [ADR-0042](0042-process-supervision-and-single-instance-locking.md) — supplies the restart-with-backoff supervision this ADR leaves out ("no automatic restart on crash"), split by key custody, plus OS-advisory-lock single-instance enforcement
