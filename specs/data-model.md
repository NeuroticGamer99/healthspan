...
- **Audit trail** — decided ([ADR-0027](adr/0027-audit-trail-and-corrections.md)): platform-wide append-only `audit_log`, written in the same transaction as every mutation, in the schema from migration 0001; event sourcing was considered and rejected
